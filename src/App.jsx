...
function App() {
  ...
  const [categoriasRecuperadas, setCategoriasRecuperadas] =
    useState(categorias);
  ...
  return (
    <div className="bg-indigo-100 w-screen h-screen p-3">
      ...
      <div className="categorias">
        {categoriasRecuperadas.map((categoria) => (
          <div className="corpo" key={categoria.titulo}>
            <div className="titulo font-sans font-bold text-2xl text-indigo-900">
              {categoria.titulo}
            </div>
              ...
              {categoria.botoes.map((botao) => {
                return (
                  <Button
                    ...
                    setCategoriasRecuperadas={setCategoriasRecuperadas}
                  />
                );
              })}
            </div>
